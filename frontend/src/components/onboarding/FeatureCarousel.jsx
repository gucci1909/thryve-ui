  ...
  return (
    <div className="container mx-auto px-6">
      ...
      <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
        <Link
          to="/signup"
          className="w-full rounded-full bg-[var(--primary-color)] px-8 py-3 text-center font-medium text-white shadow-md transition-all hover:scale-[1.02] hover:shadow-lg sm:w-auto"
        >
          Create Account
        </Link>
        <Link
          to="/login"
          className="w-full rounded-full border-2 border-[var(--primary-color)] px-8 py-3 text-center font-medium text-[var(--primary-color)] transition-all hover:scale-[1.02] hover:bg-blue-50 sm:w-auto"
        >
          Sign In
        </Link>
      </div>
