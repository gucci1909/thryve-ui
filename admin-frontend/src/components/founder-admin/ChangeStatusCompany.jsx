...
const ChangeStatusCompany = ({
  ...
  const status = company.status === "active" ? "Deactivate" : "Reactivate";
  const isDeactivating = company.status === "active";
          ...
          <div className="p-6">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">
                  {isDeactivating ? "Deactivate Company" : "Reactivate Company"}
                </h3>
            ...
            <div className="mt-6 flex justify-end space-x-3">
              ...
              <motion.button
                ...
                type="button"
                disabled={isLoading}
                onClick={() => handleChangeStatus(company._id, !isDeactivating)}
