export const getRolePlayingPrompt = (question, leadershipReport, company, existingChat) => {
  const cleanContext =
  ...
  Your are now being asked to coach the user as a roleplay activity and hence before you engage in the roleplay you should understand the scenario and ask any clarifying questions to define the scenario. Even while engaging in the roleplay, feel free to ask any clarifying questions in between the roleplay so that the roleplay session looks like a real session for the end user. You should end the scenario after 12 discussions and provide a summary at the end of important points for the end user as a learning
